...
type FilterKey = "type" | "ownership" | "status";
...
const filterConfig: {
...
}[] = [
  {
    ...
    label: "Asset type",
    allLabel: "All types",
    options: toOptions(assetTypeValues, assetTypeLabels),
  },
  {
    key: "ownership",
    label: "Ownership",
    allLabel: "All ownership",
    options: toOptions(ownershipTypeValues, ownershipTypeLabels),
  },
  {
    key: "status",
    label: "Status",
    ...
    <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-end">
      {filterConfig.map((filter) => {
        ...
        return (
          <div
            key={filter.key}
            className="flex flex-col gap-1.5 sm:w-52"
          >
