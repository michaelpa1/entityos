...
type FilterKey = "type" | "confidence" | "importance";
...
const filterConfig: {
...
}[] = [
  {
    ...
    label: "Claim type",
    allLabel: "All types",
    options: toOptions(claimTypeValues, claimTypeLabels),
  },
  {
    key: "confidence",
    label: "Confidence",
    allLabel: "All confidence",
    options: toOptions(confidenceValues, confidenceLabels),
  },
  {
    key: "importance",
    label: "Public importance",
    allLabel: "All importance",
    options: toOptions(publicImportanceValues, publicImportanceLabels),
  },
];
